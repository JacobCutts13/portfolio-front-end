...
export default function SimpleOrbitsProject(): JSX.Element {
  ...
  useEffect(() => {
    ...
    const getTotalLikes = async () => {
      axios
        .get("https://jc13-portfolio.herokuapp.com/projects/5/likes")
  ...
  const postLike = async () => {
    const ApiUrl = "https://jc13-portfolio.herokuapp.com/projects/5/likes";
  ...
  return (
    <>
      ...
      <section id="about">
        <iframe
          title="Simple Orbits Journal"
          src="https://v1.embednotion.com/embed/1588c094674743af9733d5800bd8f806"
        ></iframe>
      </section>
