...
export default function RayCastProject(): JSX.Element {
  ...
  useEffect(() => {
    ...
    const getTotalLikes = async () => {
      axios
        .get("https://jc13-portfolio.herokuapp.com/projects/4/likes")
  ...
  const postLike = async () => {
    const ApiUrl = "https://jc13-portfolio.herokuapp.com/projects/4/likes";
  ...
  return (
    <>
      ...
      <section id="about">
        <iframe
          title="Ray Cast Journal"
          src="https://v1.embednotion.com/embed/4e91f9dbdbb043fab1e98cefbf62eeb1"
        ></iframe>
      </section>
