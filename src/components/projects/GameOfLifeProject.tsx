...
export default function GameOfLifeProject(): JSX.Element {
  ...
  useEffect(() => {
    ...
    const getTotalLikes = async () => {
      axios
        .get("https://jc13-portfolio.herokuapp.com/projects/3/likes")
  ...
  const postLike = async () => {
    const ApiUrl = "https://jc13-portfolio.herokuapp.com/projects/3/likes";
  ...
  return (
    <>
      ...
      <section id="about">
        <iframe
          title="Game of life Journal"
          src="https://v1.embednotion.com/embed/d4275b4c15d7442bacb1599fbd1d3ff7"
        ></iframe>
      </section>
